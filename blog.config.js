...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '我梦见一片焦土,一株破土而生的新蕊,它迎着朝阳绽放,向我低语呢喃。', // 作者简介
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/ZSCGR', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/401017501', // B站主页
  ...
  WIDGET_PET_LINK:
    ...
    'https://cdn.jsdelivr.net/gh/stevenjoezhang/live2d-widget@latest/waifu-tips.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
